...
class Interfaz():
    ...
    def __init__(self):
        titulos=["Identificador", "Valor", "color", "Tamaño", "Color"]
        columnas=["id", "valor","color", "tamaño", "color"]
        data=[]
        self.root=Tk()
    ...
    def mostrar_interfaz(self):
        ...
        def eventoVvalor(event):
            global valor
            if Validaciones.validarvalor(usuario.valor): # type: ignore
                textoVvalor=""
            else:
        ...
        def eventoVpeso(event):
            global peso
            if Validaciones.validarpeso(usuario.peso): # type: ignore
                textoVpeso=""
            else:
        ...
        def eventoVtamaño(event):
            ...
            if Validaciones.validartamaño(usuario.tamaño): # type: ignore
                textoVtamaño=""
            else:
        ...
        def eventoVcolor(event):
            global color
            valorcolor = txtAtr4.get() 
            if Validaciones.validarcolor(usuario.color): # type: ignore
                textoVcolor=""
            else:
