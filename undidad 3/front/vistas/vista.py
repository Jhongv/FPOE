...
class Interfaz():
    ...
    def accion_guardar_boton(self, nombre, apellido, estatura, peso):
        self.comunicador.guardar(nombre, apellido, estatura, peso)

    def accion_consultar_boton(self, lblConsultarNombre,lblConsultarId, id):
        resultado = self.comunicador.consultar(id)
        print(resultado)
        print(type(resultado))
        lblConsultarNombre.config(text = resultado.get('nombre'))
        lblConsultarId.config(text = resultado.get('peso'))
